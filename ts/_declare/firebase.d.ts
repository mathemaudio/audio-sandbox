...
interface FirebaseOnDisconnect {
	...
	setWithPriority(value: any, priority: string|number): Q.Promise<void>;
	/**
	...
	update(value: Object): Q.Promise<void>;
	/**
...
interface FirebaseQuery {
	...
	once(eventType: string): Q.Promise<FirebaseDataSnapshot>
	/**
...
interface Firebase extends FirebaseQuery {
	...
	auth(authToken: string): Q.Promise<FirebaseAuthResult>;
	/**
	...
	authWithCustomToken(autoToken: string, options?:Object): Q.Promise<FirebaseAuthData>;
	/**
	...
	authAnonymously(options?: Object): Q.Promise<FirebaseAuthData>;
	/**
	...
	authWithPassword(credentials: FirebaseCredentials, options?: Object): Q.Promise<FirebaseAuthData>;
	/**
	...
	authWithOAuthPopup(provider: string, options?: Object): Q.Promise<FirebaseAuthData>;
	/**
	...
	authWithOAuthRedirect(provider: string, options?: Object): Q.Promise<void>;
	/**
	...
	authWithOAuthToken(provider: string, credentials: string|Object, options?: Object): Q.Promise<FirebaseAuthData>;
	/**
	...
	setPriority(priority: string|number): Q.Promise<void>;
	/**
...
interface FirebaseWithPromise<T> extends Firebase, Q.Promise<T> {}
