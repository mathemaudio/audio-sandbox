...
// type JQEventHandler = (eventObject: JQueryEventObject, ...args: Dynamic[]) => Dynamic;
type JQEventHandler = Function;
...
interface JQueryAjaxSettings {
     ...
     */
    complete? (jqXHR: JQueryXHR, textStatus: string): Dynamic;
    /**
     * An object of string/regular-expression pairs that determine how jQuery will parse the response, given its content type. (version added: 1.5)
     */
    contents?: { [key: string]: Dynamic; };
     ...
     */
    dataFilter? (data: Dynamic, ty: Dynamic): Dynamic;
    /**
     ...
     */
    error? (jqXHR: JQueryXHR, textStatus: string, errorThrown: string): Dynamic;
    /**
     ...
     */
    statusCode?: { [key: string]: Dynamic; };
    /**
     * A function to be called if the request succeeds. The function gets passed three arguments: The data returned from the server, formatted according to the dataType parameter; a string describing the status; and the jqXHR (in jQuery 1.4.x, XMLHttpRequest) object. As of jQuery 1.5, the success setting can accept an array of functions. Each function will be called in turn. This is an Ajax Event.
     */
    success? (data: Dynamic, textStatus: string, jqXHR: JQueryXHR): Dynamic;
    /**
     * Set a timeout (in milliseconds) for the request. This will override Dynamic global timeout set with $.ajaxSetup(). The timeout period starts at the point the $.ajax call is made; if several other requests are in progress and the browser has no connections available, it is possible for a request to time out before it can be sent. In jQuery 1.4.x and below, the XMLHttpRequest object will be in an invalid state if the request times out; accessing Dynamic object members may throw an exception. In Firefox 3.0+ only, script and JSONP requests cannot be cancelled by a timeout; the script will run even if it arrives after the timeout period.
     */
    timeout?: number;
    /**
 ...
 */
interface JQueryXHR extends XMLHttpRequest, JQueryPromise<Dynamic> {
    /**
     * The .overrideMimeType() method may be used in the beforeSend() callback function, for example, to modify the response content-type header. As of jQuery 1.5.1, the jqXHR object also contains the overrideMimeType() method (it was available in jQuery 1.4.x, as well, but was temporarily removed in jQuery 1.5).
     */
    overrideMimeType(mimeType: string): Dynamic;
    /**
     * Cancel the request.
     *
     ...
     */
    then<R>(doneCallback: (data: Dynamic, textStatus: string, jqXHR: JQueryXHR) => R|JQueryPromise<R>, failCallback?: (jqXHR: JQueryXHR, textStatus: string, errorThrown: Dynamic) => void): JQueryPromise<R>;
    /**
     * Property containing the parsed response if the response content type is json
     */
    responseJSON?: Dynamic;
    /**
...
interface JQueryCallback {
     ...
     */
    add(callbacks: Method): JQueryCallback;
    /**
     * Add a callback or a collection of callbacks to a callback list.
     *
     * @param callbacks A function, or array of functions, that are to be added to the callback list.
     ...
     */
    fire(...arguments: Dynamic[]): JQueryCallback;
     ...
     */
    fireWith(context?: Dynamic, args?: Dynamic[]): JQueryCallback;
     ...
     */
    remove(callbacks: Method): JQueryCallback;
    /**
     * Remove a callback or a collection of callbacks from a callback list.
     *
     * @param callbacks A function, or array of functions, that are to be removed from the callback list.
...
interface JQueryGenericPromise<T> {
     ...
     */
    then<U>(doneFilter: (value?: T, ...values: Dynamic[]) => U|JQueryPromise<U>, failFilter?: (...reasons: Dynamic[]) => Dynamic, progressFilter?: (...progression: Dynamic[]) => Dynamic): JQueryPromise<U>;
     ...
     * @see {@link https://api.jquery.com/deferred.then/#deferred-then-doneFilter-failFilter-progressFilter}
     */
    then(doneFilter: (value?: T, ...values: Dynamic[]) => void, failFilter?: (...reasons: Dynamic[]) => Dynamic, progressFilter?: (...progression: Dynamic[]) => Dynamic): JQueryPromise<void>;
}
...
interface JQueryPromiseCallback<T> {
    (value?: T, ...args: Dynamic[]): void;
}

interface JQueryPromiseOperator<T, U> {
    (callback1: JQueryPromiseCallback<T>|JQueryPromiseCallback<T>[], ...callbacksN: Array<JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[]>): JQueryPromise<U>;
}
...
interface JQueryPromise<T> extends JQueryGenericPromise<T> {
     ...
     */
    always(alwaysCallback1?: JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[], ...alwaysCallbackN: Array<JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[]>): JQueryPromise<T>;
    /**
     ...
     */
    fail(failCallback1?: JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[], ...failCallbackN: Array<JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[]>): JQueryPromise<T>;
    /**
     ...
     */
    progress(progressCallback1?: JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[], ...progressCallbackN: Array<JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[]>): JQueryPromise<T>;

    // Deprecated - given no typings
    pipe(doneFilter?: (x: Dynamic) => Dynamic, failFilter?: (x: Dynamic) => Dynamic, progressFilter?: (x: Dynamic) => Dynamic): JQueryPromise<Dynamic>;
     ...
     */
    promise(target?: Dynamic): JQueryPromise<T>;
}
...
interface JQueryDeferred<T> extends JQueryGenericPromise<T> {
     ...
     * @see {@link https://api.jquery.com/deferred.always/}
     */
    always(alwaysCallback1?: JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[], ...alwaysCallbackN: Array<JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[]>): JQueryDeferred<T>;
    /**
     * Add handlers to be called when the Deferred object is resolved.
     *
     * @param doneCallback1 A function, or array of functions, that are called when the Deferred is resolved.
     ...
     * @see {@link https://api.jquery.com/deferred.fail/}
     */
    fail(failCallback1?: JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[], ...failCallbackN: Array<JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[]>): JQueryDeferred<T>;
    /**
     * Add handlers to be called when the Deferred object generates progress notifications.
     *
     * @param progressCallback1 A function, or array of functions, to be called when the Deferred generates progress notifications.
     ...
     * @see {@link https://api.jquery.com/deferred.progress/}
     */
    progress(progressCallback1?: JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[], ...progressCallbackN: Array<JQueryPromiseCallback<Dynamic>|JQueryPromiseCallback<Dynamic>[]>): JQueryDeferred<T>;
     ...
     */
    notify(value?: Dynamic, ...args: Dynamic[]): JQueryDeferred<T>;
     ...
     */
    notifyWith(context: Dynamic, args?: Dynamic[]): JQueryDeferred<T>;

    /**
     * Reject a Deferred object and call Dynamic failCallbacks with the given args.
     *
     * @param args Optional arguments that are passed to the failCallbacks.
     * @see {@link https://api.jquery.com/deferred.reject/}
     */
    reject(value?: Dynamic, ...args: Dynamic[]): JQueryDeferred<T>;
    /**
     * Reject a Deferred object and call Dynamic failCallbacks with the given context and args.
     *
     * @param context Context passed to the failCallbacks as the this object.
     * @param args An optional array of arguments that are passed to the failCallbacks.
     * @see {@link https://api.jquery.com/deferred.rejectWith/}
     */
    rejectWith(context: Dynamic, args?: Dynamic[]): JQueryDeferred<T>;

    /**
     * Resolve a Deferred object and call Dynamic doneCallbacks with the given args.
     *
     * @param value First argument passed to doneCallbacks.
     * @param args Optional subsequent arguments that are passed to the doneCallbacks.
     * @see {@link https://api.jquery.com/deferred.resolve/}
     */
    resolve(value?: T, ...args: Dynamic[]): JQueryDeferred<T>;

    /**
     * Resolve a Deferred object and call Dynamic doneCallbacks with the given context and args.
     *
     * @param context Context passed to the doneCallbacks as the this object.
     * @param args An optional array of arguments that are passed to the doneCallbacks.
     * @see {@link https://api.jquery.com/deferred.resolveWith/}
     */
    resolveWith(context: Dynamic, args?: T[]): JQueryDeferred<T>;
...
interface BaseJQueryEventObject extends Event {
    /**
     * The current DOM element within the event bubbling position.
    ...
    /**
     * The other DOM element involved in the event, if Dynamic.
    ...
    /**
     * Prevents the event from bubbling up the DOM tree, preventing Dynamic parent handlers from being notified of the event.
...
interface JQueryParam {
     ...
     */
    (obj: Dynamic, traditional: boolean): string;
}
...
interface JQueryEventConstructor {
    (name: string, eventProperties?: Dynamic): JQueryEventObject;
    new (name: string, eventProperties?: Dynamic): JQueryEventObject;
}
...
interface JQueryAnimationOptions {
     ...
     */
    step?: (now: number, tween: Dynamic) => Dynamic;
    /**
     * A function to be called after each step of the animation, only once per animated element regardless of the number of animated properties. (version added: 1.8)
     */
    progress?: (animation: JQueryPromise<Dynamic>, progress: number, remainingMs: number) => Dynamic;
    /**
     * A function to call when the animation begins. (version added: 1.8)
     */
    start?: (animation: JQueryPromise<Dynamic>) => Dynamic;
    /**
     * A function to be called when the animation completes (its Promise object is resolved). (version added: 1.8)
     */
    done?: (animation: JQueryPromise<Dynamic>, jumpedToEnd: boolean) => Dynamic;
    /**
     * A function to be called when the animation fails to complete (its Promise object is rejected). (version added: 1.8)
     */
    fail?: (animation: JQueryPromise<Dynamic>, jumpedToEnd: boolean) => Dynamic;
    /**
     * A function to be called when the animation completes or stops without completing (its Promise object is either resolved or rejected). (version added: 1.8)
     */
    always?: (animation: JQueryPromise<Dynamic>, jumpedToEnd: boolean) => Dynamic;
    /**
...
interface JQueryStatic {
     ...
     *
     * @param settings A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for Dynamic option with $.ajaxSetup().
     * @see {@link https://api.jquery.com/jQuery.ajax/#jQuery-ajax-settings}
     */
     ...
     */
    ajaxPrefilter(dataTypes: string, handler: (opts: Dynamic, originalOpts: JQueryAjaxSettings, jqXHR: JQueryXHR) => Dynamic): void;
    /**
     * Handle custom Ajax options or modify existing options before each request is sent and before they are processed by $.ajax().
     *
     * @param handler A handler to set default values for future Ajax requests.
     * @see {@link https://api.jquery.com/jQuery.ajaxPrefilter/}
     */
    ajaxPrefilter(handler: (opts: Dynamic, originalOpts: JQueryAjaxSettings, jqXHR: JQueryXHR) => Dynamic): void;
     ...
     */
    ajaxTransport(dataType: string, handler: (opts: Dynamic, originalOpts: JQueryAjaxSettings, jqXHR: JQueryXHR) => Dynamic): void;
     ...
     */
    get(url: string, success?: (data: Dynamic, textStatus: string, jqXHR: JQueryXHR) => Dynamic, dataType?: string): JQueryXHR;
    /**
     * Load data from the server using a HTTP GET request.
     *
     * @param url A string containing the URL to which the request is sent.
     ...
     * @see {@link https://api.jquery.com/jQuery.get/#jQuery-get-url-data-success-dataType}
     */
    get(url: string, data?: Object|string, success?: (data: Dynamic, textStatus: string, jqXHR: JQueryXHR) => Dynamic, dataType?: string): JQueryXHR;
    /**
     * Load data from the server using a HTTP GET request.
     *
     ...
     */
    getJSON(url: string, success?: (data: Dynamic, textStatus: string, jqXHR: JQueryXHR) => Dynamic): JQueryXHR;
    /**
     * Load JSON-encoded data from the server using a GET HTTP request.
     *
     * @param url A string containing the URL to which the request is sent.
     ...
     * @see {@link https://api.jquery.com/jQuery.getJSON/}
     */
    getJSON(url: string, data?: Object|string, success?: (data: Dynamic, textStatus: string, jqXHR: JQueryXHR) => Dynamic): JQueryXHR;
    /**
     ...
     */
    getScript(url: string, success?: (script: string, textStatus: string, jqXHR: JQueryXHR) => Dynamic): JQueryXHR;
     ...
     */
    post(url: string, success?: (data: Dynamic, textStatus: string, jqXHR: JQueryXHR) => Dynamic, dataType?: string): JQueryXHR;
    /**
     * Load data from the server using a HTTP POST request.
     *
     * @param url A string containing the URL to which the request is sent.
     ...
     * @see {@link https://api.jquery.com/jQuery.post/#jQuery-post-url-data-success-dataType}
     */
    post(url: string, data?: Object|string, success?: (data: Dynamic, textStatus: string, jqXHR: JQueryXHR) => Dynamic, dataType?: string): JQueryXHR;
    /**
     * Load data from the server using a HTTP POST request.
     *
     * @param settings The JQueryAjaxSettings to be used for the request
     ...
     */
    (callback: (jQueryAlias?: JQueryStatic) => Dynamic): JQuery;
     ...
     */
    data(element: Element, key: string): Dynamic;
    /**
     * Returns value at named data store for the element, as set by jQuery.data(element, name, value), or the full data store for the element.
     *
     * @param element The DOM element to associate with the data.
    ...
    /**
     * Determine whether an element has Dynamic jQuery data associated with it.
     *
     ...
     */
    queue(element: Element, queueName?: string): Dynamic[];
    /**
     ...
     */
    queue(element: Element, queueName: string, newQueue: Method[]): JQuery;
    /**
     * Manipulate the queue of functions to be executed on the matched element.
     *
     ...
     */
    queue(element: Element, queueName: string, callback: Method): JQuery;
    ...
    /**
     * A constructor function that returns a chainable utility object with methods to register multiple callbacks into callback queues, invoke callback queues, and relay the success or failure state of Dynamic synchronous or asynchronous function.
     *
     * @param beforeStart A function that is called just before the constructor returns.
     * @see {@link https://api.jquery.com/jQuery.Deferred/}
     */
    Deferred<T>(beforeStart?: (deferred: JQueryDeferred<T>) => Dynamic): JQueryDeferred<T>;
     ...
     */
    proxy(func: (...args: Dynamic[]) => Dynamic, context: Object, ...additionalArguments: Dynamic[]): Dynamic;
    /**
     * Takes a function and returns a new one that will always have a particular context.
     *
     * @param context The object to which the context (this) of the function should be set.
     ...
     */
    proxy(context: Object, name: string, ...additionalArguments: Dynamic[]): Dynamic;
     ...
     */
    error(message: Dynamic): JQuery;

    expr: Dynamic;
    fn: Dynamic;  //TODO: Decide how we want to type this
    ...
    /**
     * A generic iterator function, which can be used to seamlessly iterate over both objects and arrays. Arrays and array-like objects with a size property (such as a function's arguments object) are iterated by numeric index, from 0 to size-1. Other objects are iterated via their named properties.
     *
    ...
    each<T>(
        collection: T[],
        callback: (indexInArray: number, valueOfElement: T) => Dynamic
    ): Dynamic;
    ...
    each(
        collection: Dynamic,
        callback: (indexInArray: Dynamic, valueOfElement: Dynamic) => Dynamic
    ): Dynamic;
     ...
     */
    extend(target: Dynamic, object1?: Dynamic, ...objectN: Dynamic[]): Dynamic;
    /**
     * Merge the contents of two or more objects together into the first object.
     *
     ...
     */
    extend(deep: boolean, target: Dynamic, object1?: Dynamic, ...objectN: Dynamic[]): Dynamic;
     ...
     */
    globalEval(code: string): Dynamic;
     ...
     */
    isEmptyObject(obj: Dynamic): boolean;
    /**
     ...
     */
    isFunction(obj: Dynamic): boolean;
    /**
     ...
     */
    isNumeric(value: Dynamic): boolean;
    /**
     ...
     */
    isPlainObject(obj: Dynamic): boolean;
    /**
     ...
     */
    makeArray(obj: Dynamic): Dynamic[];

    /**
     * Translate all items in an array or object to new array of items.
     *
     * @param array The Array to translate.
     * @param callback The function to process each item against. The first argument to the function is the array item, the second argument is the index in array The function can return Dynamic value. Within the function, this refers to the global (window) object.
     ...
     * @param callback The function to process each item against. The first argument to the function is the value; the second argument is the index or key of the array or object property. The function can return Dynamic value to add to the array. A returned array will be flattened into the resulting array. Within the function, this refers to the global (window) object.
     * @see {@link https://api.jquery.com/jQuery.map/#jQuery-map-object-callback}
     */
    map(arrayOrObject: Dynamic, callback: (value?: Dynamic, indexOrKey?: Dynamic) => Dynamic): Dynamic;
     ...
     */
    parseHTML(data: string, context?: HTMLElement, keepScripts?: boolean): Dynamic[];
     ...
     * @see {@link https://api.jquery.com/jQuery.parseHTML/}
     */
    parseHTML(data: string, context?: Document, keepScripts?: boolean): Dynamic[];
}
...
interface JQuery {
     ...
     */
    ajaxComplete(handler: (event: JQueryEventObject, XMLHttpRequest: XMLHttpRequest, ajaxOptions: Dynamic) => Dynamic): JQuery;
    /**
     ...
     */
    ajaxError(handler: (event: JQueryEventObject, jqXHR: JQueryXHR, ajaxSettings: JQueryAjaxSettings, thrownError: Dynamic) => Dynamic): JQuery;
    /**
     ...
     */
    ajaxSend(handler: (event: JQueryEventObject, jqXHR: JQueryXHR, ajaxOptions: JQueryAjaxSettings) => Dynamic): JQuery;
    /**
     ...
     */
    ajaxStart(handler: () => Dynamic): JQuery;
    /**
     ...
     */
    ajaxStop(handler: () => Dynamic): JQuery;
    /**
     ...
     */
    ajaxSuccess(handler: (event: JQueryEventObject, XMLHttpRequest: XMLHttpRequest, ajaxOptions: JQueryAjaxSettings) => Dynamic): JQuery;
     ...
     */
    load(url: string, data?: string|Object, complete?: (responseText: string, textStatus: string, XMLHttpRequest: XMLHttpRequest) => Dynamic): JQuery;
    ...
    /**
     * Determine whether Dynamic of the matched elements are assigned the given class.
     *
     ...
     */
    prop(propertyName: string, func: (index: number, oldPropertyValue: Dynamic) => Dynamic): JQuery;
     ...
     *
     * @param key A string naming the piece of data to set.
     * @param value The new data value; it can be Dynamic JavaScript type including Array or Object.
     ...
     */
    data(obj: { [key: string]: Dynamic; }): JQuery;
    /**
     * Return the value at the named data store for the first element in the jQuery collection, as set by data(name, value) or by an HTML5 data-* attribute.
     ...
     */
    promise(type?: string, target?: Object): JQueryPromise<Dynamic>;
     ...
     */
    animate(properties: Object, duration?: string|number, complete?: Method): JQuery;
    /**
     * Perform a custom animation of a set of CSS properties.
     *
     * @param properties An object of CSS properties and values that the animation will move toward.
     ...
     * @see {@link https://api.jquery.com/animate/#animate-properties-duration-easing-complete}
     */
    animate(properties: Object, duration?: string|number, easing?: string, complete?: Method): JQuery;
    /**
     * Perform a custom animation of a set of CSS properties.
     *
     * @param properties An object of CSS properties and values that the animation will move toward.
     ...
     */
    fadeIn(duration?: number|string, complete?: Method): JQuery;
    /**
     * Display the matched elements by fading them to opaque.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     */
    fadeIn(duration?: number|string, easing?: string, complete?: Method): JQuery;
    /**
     * Display the matched elements by fading them to opaque.
     *
     * @param options A map of additional options to pass to the method.
     ...
     */
    fadeOut(duration?: number|string, complete?: Method): JQuery;
    /**
     * Hide the matched elements by fading them to transparent.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     */
    fadeOut(duration?: number|string, easing?: string, complete?: Method): JQuery;
    /**
     * Hide the matched elements by fading them to transparent.
     *
     * @param options A map of additional options to pass to the method.
     ...
     */
    fadeTo(duration: string|number, opacity: number, complete?: Method): JQuery;
    /**
     * Adjust the opacity of the matched elements.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     */
    fadeTo(duration: string|number, opacity: number, easing?: string, complete?: Method): JQuery;
     ...
     */
    fadeToggle(duration?: number|string, complete?: Method): JQuery;
    /**
     * Display or hide the matched elements by animating their opacity.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     * @see {@link https://api.jquery.com/fadeToggle/#fadeToggle-duration-easing-complete}
     */
    fadeToggle(duration?: number|string, easing?: string, complete?: Method): JQuery;
    /**
     * Display or hide the matched elements by animating their opacity.
     *
     * @param options A map of additional options to pass to the method.
     ...
     */
    hide(duration?: number|string, complete?: Method): JQuery;
    /**
     * Hide the matched elements.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     */
    hide(duration?: number|string, easing?: string, complete?: Method): JQuery;
    /**
     * Hide the matched elements.
     *
     * @param options A map of additional options to pass to the method.
     ...
     */
    show(duration?: number|string, complete?: Method): JQuery;
    /**
     * Display the matched elements.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     */
    show(duration?: number|string, easing?: string, complete?: Method): JQuery;
    /**
     * Display the matched elements.
     *
     * @param options A map of additional options to pass to the method.
     ...
     */
    slideDown(duration?: number|string, complete?: Method): JQuery;
    /**
     * Display the matched elements with a sliding motion.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     */
    slideDown(duration?: number|string, easing?: string, complete?: Method): JQuery;
    /**
     * Display the matched elements with a sliding motion.
     *
     * @param options A map of additional options to pass to the method.
     ...
     */
    slideToggle(duration?: number|string, complete?: Method): JQuery;
    /**
     * Display or hide the matched elements with a sliding motion.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     */
    slideToggle(duration?: number|string, easing?: string, complete?: Method): JQuery;
    /**
     * Display or hide the matched elements with a sliding motion.
     *
     * @param options A map of additional options to pass to the method.
     ...
     */
    slideUp(duration?: number|string, complete?: Method): JQuery;
    /**
     * Hide the matched elements with a sliding motion.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     */
    slideUp(duration?: number|string, easing?: string, complete?: Method): JQuery;
    /**
     * Hide the matched elements with a sliding motion.
     *
     * @param options A map of additional options to pass to the method.
     ...
     */
    toggle(duration?: number|string, complete?: Method): JQuery;
    /**
     * Display or hide the matched elements.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     */
    toggle(duration?: number|string, easing?: string, complete?: Method): JQuery;
    /**
     * Display or hide the matched elements.
     *
     * @param options A map of additional options to pass to the method.
     ...
     */
    bind(eventType: string, eventData: Dynamic, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Attach a handler to an event for the elements.
     *
     * @param eventType A string containing one or more DOM event types, such as "click" or "submit," or custom event names.
     ...
     * @see {@link https://api.jquery.com/bind/#bind-eventType-eventData-handler}
     */
    bind(eventType: string, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Attach a handler to an event for the elements.
     *
     * @param eventType A string containing one or more DOM event types, such as "click" or "submit," or custom event names.
     ...
     */
    bind(eventType: string, eventData: Dynamic, preventBubble: boolean): JQuery;
    /**
     * Attach a handler to an event for the elements.
     *
     * @param eventType A string containing one or more DOM event types, such as "click" or "submit," or custom event names.
     ...
     */
    blur(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "blur" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    blur(eventData?: Dynamic, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    change(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "change" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    change(eventData?: Dynamic, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    click(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "click" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    click(eventData?: Dynamic, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    contextmenu(handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "contextmenu" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    contextmenu(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
     ...
     */
    dblclick(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "dblclick" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    dblclick(eventData?: Dynamic, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;

    /**
     * Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a specific set of root elements.
     * @see {@link https://api.jquery.com/delegate/#delegate-selector-eventType-handler}
     */
    delegate(selector: Dynamic, eventType: string, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a specific set of root elements.
     * @see {@link https://api.jquery.com/delegate/#delegate-selector-eventType-eventData-handler}
     */
    delegate(selector: Dynamic, eventType: string, eventData: Dynamic, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    focus(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "focus" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    focus(eventData?: Dynamic, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    focusin(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "focusin" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    focusin(eventData: Object, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    focusout(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "focusout" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    focusout(eventData: Object, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    hover(handlerIn: (eventObject: JQueryEventObject) => Dynamic, handlerOut: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     ...
     */
    hover(handlerInOut: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    keydown(handler: (eventObject: JQueryKeyEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "keydown" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    keydown(eventData?: Dynamic, handler?: (eventObject: JQueryKeyEventObject) => Dynamic): JQuery;
     ...
     */
    keypress(handler: (eventObject: JQueryKeyEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "keypress" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    keypress(eventData?: Dynamic, handler?: (eventObject: JQueryKeyEventObject) => Dynamic): JQuery;
     ...
     */
    keyup(handler: (eventObject: JQueryKeyEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "keyup" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    keyup(eventData?: Dynamic, handler?: (eventObject: JQueryKeyEventObject) => Dynamic): JQuery;
     ...
     * @see {@link https://api.jquery.com/load/}
     */
    load(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "load" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     * @see {@link https://api.jquery.com/load/}
     */
    load(eventData?: Dynamic, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    mousedown(handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "mousedown" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    mousedown(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
     ...
     */
    mouseenter(handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to be fired when the mouse enters an element.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    mouseenter(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
     ...
     */
    mouseleave(handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to be fired when the mouse leaves an element.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    mouseleave(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
     ...
     */
    mousemove(handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "mousemove" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    mousemove(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
     ...
     */
    mouseout(handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "mouseout" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    mouseout(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
     ...
     */
    mouseover(handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "mouseover" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    mouseover(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
     ...
     */
    mouseup(handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "mouseup" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    mouseup(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => Dynamic): JQuery;
     ...
     */
    off(events: string, selector?: string, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Remove an event handler.
     *
     * @param events One or more space-separated event types and optional namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".
     ...
     * @see {@link https://api.jquery.com/off/#off-events-selector-handler}
     */
    off(events: string, handler: (eventObject: JQueryEventObject, ...args: Dynamic[]) => Dynamic): JQuery;
    /**
     * Remove an event handler.
     *
     * @param events One or more space-separated event types and optional namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".
     ...
     * @see {@link https://api.jquery.com/off/#off-events-selector-handler}
     */
    off(events: string, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Remove an event handler.
     *
     ...
     */
    off(events: { [key: string]: Dynamic; }, selector?: string): JQuery;
    /**
     ...
     * @see {@link https://api.jquery.com/on/#on-events-selector-data-handler}
     */
    on(events: string, data : Dynamic, handler: JQEventHandler): JQuery;
    /**
     * Attach an event handler function for one or more events to the selected elements.
     *
     * @param events One or more space-separated event types and optional namespaces, such as "click" or "keydown.myPlugin".
     ...
     * @see {@link https://api.jquery.com/on/#on-events-selector-data-handler}
     */
    on(events: string, selector: string, data: Dynamic, handler: JQEventHandler): JQuery;
    // /**
    //  * Attach an event handler function for one or more events to the selected elements.
    //  *
    ...
    //  */
    // on(events: { [key: string]: Dynamic; }, selector?: string, data?: Dynamic): JQuery;
    // /**
    //  * Attach an event handler function for one or more events to the selected elements.
    //  *
    //  * @param events An object in which the string keys represent one or more space-separated event types and optional namespaces, and the values represent a handler function to be called for the event(s).
    ...
    //  * @see {@link https://api.jquery.com/on/#on-events-selector-data}
    //  */
    // on(events: { [key: string]: Dynamic; }, data?: Dynamic): JQuery;
     ...
     */
    one(events: string, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Attach a handler to an event for the elements. The handler is executed at most once per element per event type.
     *
     * @param events A string containing one or more JavaScript event types, such as "click" or "submit," or custom event names.
     ...
     * @see {@link https://api.jquery.com/one/#one-events-data-handler}
     */
    one(events: string, data: Object, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    one(events: string, selector: string, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Attach a handler to an event for the elements. The handler is executed at most once per element per event type.
     *
     * @param events One or more space-separated event types and optional namespaces, such as "click" or "keydown.myPlugin".
     ...
     * @see {@link https://api.jquery.com/one/#one-events-selector-data-handler}
     */
    one(events: string, selector: string, data: Dynamic, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    one(events: { [key: string]: Dynamic; }, selector?: string, data?: Dynamic): JQuery;
     ...
     * @see {@link https://api.jquery.com/one/#one-events-selector-data}
     */
    one(events: { [key: string]: Dynamic; }, data?: Dynamic): JQuery;
     ...
     */
    ready(handler: (jQueryAlias?: JQueryStatic) => Dynamic): JQuery;
     ...
     */
    resize(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "resize" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    resize(eventData: Object, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    scroll(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "scroll" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    scroll(eventData: Object, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    select(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "select" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    select(eventData: Object, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    submit(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "submit" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     ...
     */
    submit(eventData?: Dynamic, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    trigger(eventType: string, extraParameters?: Dynamic[]|Object): JQuery;
    /**
     * Execute all handlers and behaviors attached to the matched elements for the given event type.
     *
     ...
     */
    trigger(event: JQueryEventObject, extraParameters?: Dynamic[]|Object): JQuery;
     ...
     */
    triggerHandler(eventType: string, ...extraParameters: Dynamic[]): Object;
     ...
     */
    triggerHandler(event: JQueryEventObject, ...extraParameters: Dynamic[]): Object;
     ...
     */
    unbind(eventType?: string, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Remove a previously-attached event handler from the elements.
     *
     * @param eventType A string containing a JavaScript event type, such as click or submit.
     ...
     */
    undelegate(selector: string, eventType: string, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Remove a handler from the event for all elements which match the current selector, based upon a specific set of root elements.
     *
     * @param selector A selector which will be used to filter the event results.
     ...
     */
    unload(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "unload" JavaScript event. (DEPRECATED from v1.8)
     *
     ...
     */
    unload(eventData?: Dynamic, handler?: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    error(handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
    /**
     * Bind an event handler to the "error" JavaScript event. (DEPRECATED from v1.8)
     *
     * @param eventData A plain object of data that will be passed to the event handler.
     ...
     */
    error(eventData: Dynamic, handler: (eventObject: JQueryEventObject) => Dynamic): JQuery;
     ...
     */
    pushStack(elements: Dynamic[]): JQuery;
    /**
     * Add a collection of DOM elements onto the jQuery stack.
     *
     * @param elements An array of elements to push onto the stack and make into a new jQuery object.
     ...
     */
    pushStack(elements: Dynamic[], name: string, arguments: Dynamic[]): JQuery;
     ...
     */
    after(content1: JQuery|Dynamic[]|Element|DocumentFragment|Text|string, ...content2: Dynamic[]): JQuery;
    /**
     * Insert content, specified by the parameter, after each element in the set of matched elements.
     *
     ...
     */
    append(content1: JQuery|Dynamic[]|Element|DocumentFragment|Text|string, ...content2: Dynamic[]): JQuery;
    /**
     * Insert content, specified by the parameter, to the end of each element in the set of matched elements.
     *
     ...
     */
    appendTo(target: JQuery|Dynamic[]|Element|string): JQuery;
     ...
     */
    before(content1: JQuery|Dynamic[]|Element|DocumentFragment|Text|string, ...content2: Dynamic[]): JQuery;
    /**
     * Insert content, specified by the parameter, before each element in the set of matched elements.
     *
     ...
     */
    insertAfter(target: JQuery|Dynamic[]|Element|Text|string): JQuery;
     ...
     */
    insertBefore(target: JQuery|Dynamic[]|Element|Text|string): JQuery;
     ...
     */
    prepend(content1: JQuery|Dynamic[]|Element|DocumentFragment|Text|string, ...content2: Dynamic[]): JQuery;
    /**
     * Insert content, specified by the parameter, to the beginning of each element in the set of matched elements.
     *
     ...
     */
    prependTo(target: JQuery|Dynamic[]|Element|string): JQuery;
     ...
     */
    replaceAll(target: JQuery|Dynamic[]|Element|string): JQuery;
     ...
     */
    replaceWith(newContent: JQuery|Dynamic[]|Element|Text|string): JQuery;
    /**
     * Replace each element in the set of matched elements with the provided new content and return the set of elements that was removed.
     *
     ...
     */
    each(func: (index: number, elem: Element) => Dynamic): JQuery;
    ...
    length: number;
    /**
     * A selector representing selector passed to jQuery(), if Dynamic, when creating the original set.
     ...
     */
    closest(selectors: Dynamic, context?: Element): Dynamic[];
     ...
     */
    filter(func: (index: number, element: Element) => Dynamic): JQuery;
    /**
     * Reduce the set of matched elements to those that match the selector or pass the function's test.
     *
     ...
     */
    map(callback: (index: number, domElement: Element) => Dynamic): JQuery;
     ...
     */
    queue(queueName?: string): Dynamic[];
    /**
     ...
     * @see {@link https://api.jquery.com/queue/#queue-queueName-newQueue}
     */
    queue(queueName: string, newQueue: Method[]): JQuery;
    /**
     * Manipulate the queue of functions to be executed, once for each matched element.
     *
     * @param queueName A string containing the name of the queue. Defaults to fx, the standard effects queue.
     ...
     * @see {@link https://api.jquery.com/queue/#queue-queueName-callback}
     */
    queue(queueName: string, callback: Method): JQuery;
}
